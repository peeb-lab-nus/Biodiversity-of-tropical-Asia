####################################################################################################
### Cleaning OBIS data for Sponges
### Charlie Marsh
### charliem2003@github
### 12/2024
###
...
### Filter just the sponges (988,032 rows)
obis <- obis_par %>%
...
cleaned <- runCleaningSteps(gbif             = obis,        # prepared obis data frame, with cols Flag and Flag_step added
                            ...
                            pathFilteredData = file.path(resDir, "obis_filtered_sponges.csv"), # path and file name of obis data with flagged data filtered out.
                            plot = FALSE)
