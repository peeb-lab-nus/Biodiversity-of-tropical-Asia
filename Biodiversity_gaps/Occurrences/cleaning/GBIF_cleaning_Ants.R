...
### Filter out just the ants (3,224,599 rows)
gbif <- gbif_par %>%
...
cleaned <- runCleaningSteps(gbif             = gbif,        # prepared gbif data frame, with cols Flag and Flag_step added
                            ...
                            pathFilteredData = file.path(resDir, "gbif_filtered_ants.csv"), # path and file name of gbif data with flagged data filtered out.
                            plot = FALSE)
