####################################################################################################
### Cleaning GBIF data for Spiders
### Charlie Marsh
### charliem2003@github
### 12/2024
###
...
### Filter just the spiders (6,405,520 rows)
gbif <- gbif_par %>%
...
cleaned <- runCleaningSteps(gbif             = gbif,        # prepared gbif data frame, with cols Flag and Flag_step added
                            ...
                            pathFilteredData = file.path(resDir, "gbif_filtered_spiders.csv"), # path and file name of gbif data with flagged data filtered out.
                            plot = FALSE)
