####################################################################################################
### Cleaning GBIF data for Chilopods
### Charlie Marsh
### charliem2003@github
### 12/2024
###
...
### Filter just the chilopods (232,212 rows)
gbif <- gbif_par %>%
...
cleaned <- runCleaningSteps(gbif             = gbif,        # prepared gbif data frame, with cols Flag and Flag_step added
                            ...
                            pathFilteredData = file.path(resDir, "gbif_filtered_chilopods.csv"), # path and file name of gbif data with flagged data filtered out.
                            plot = FALSE)
