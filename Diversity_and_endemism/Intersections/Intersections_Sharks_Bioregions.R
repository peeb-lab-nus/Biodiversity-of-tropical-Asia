####################################################################################################
### Run intersections between marine sharks and rays (class: Chondrichthyes) and marine ecoregions
...
### filter out non-relevant range polygons - 1,212 polygons, 1,177 species
rangemaps <- rangemaps %>%
...
### total species list extracted from range maps - 1,180 species - 1,177 with range maps
...
pa0_0 <- convertToPA(rangeIntersects = intersections,    # data frame of occupied area for species range maps x bioregions
                     ...
                     verbose         = TRUE)
write.csv(pa0_0, file.path(resDir, "Intersections", "Intersections_bioregions_sharks_0_0.csv"),
...
pa2.5_15 <- convertToPA(rangeIntersects = intersections, # data frame of occupied area for species range maps x bioregions
                        ...
                        regions         = regions,       # shapefile with bioregions
                        verbose         = TRUE)
write.csv(pa2.5_15, file.path(resDir, "Intersections", "Intersections_bioregions_sharks_2.5_15.csv"),
          quote = FALSE, row.names = FALSE)
...
pa5.0_25 <- convertToPA(rangeIntersects = intersections, # data frame of occupied area for species range maps x bioregions
                        ...
                        regions         = regions,       # shapefile with bioregions
                        verbose         = TRUE)
write.csv(pa5.0_25, file.path(resDir, "Intersections", "Intersections_bioregions_sharks_5.0_25.csv"),
          quote = FALSE, row.names = FALSE)
...
pa7.5_35 <- convertToPA(rangeIntersects = intersections, # data frame of occupied area for species range maps x bioregions
                        ...
                        regions         = regions,       # shapefile with bioregions
                        verbose         = TRUE)
write.csv(pa7.5_35, file.path(resDir, "Intersections", "Intersections_bioregions_sharks_7.5_35.csv"),
          quote = FALSE, row.names = FALSE)
...
write.csv(allSp, file.path(resDir, "Intersections", "Intersections_bioregions_sharks_spList.csv"),
          quote = FALSE, row.names = FALSE)
