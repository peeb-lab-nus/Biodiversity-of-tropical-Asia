####################################################################################################
### Functions for modifying alpha hulls where the functions from alphahull break down.
###
### Originally the work of Cecina Babich Morrow:
###   taken from this blog: https://babichmorrowc.github.io/post/2019-03-18-alpha-hull/
###   and also available from this github: https://github.com/babichmorrowc/hull2spatial
###
### I have just modified it to convert to sf instead of sp, a very trivial modification
###
### Charlie Marsh
### charliem2003@github
### 06/2024
...
ahull2lines <- function(hull){
  ...
  ### Convert to sf object instead of sp
  sp_lines <- sp_lines %>%
    st_as_sf()  %>%
