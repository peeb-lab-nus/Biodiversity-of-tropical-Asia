...
### NOTE: BirdLife Interational has maps missing for the following sensitive species
...
pa5.0_25 <- convertToPA(rangeIntersects = intersections, # data frame of occupied area for species range maps x bioregions
                        ...
                        verbose         = TRUE)
write.csv(pa5.0_25, file.path(resDir, "Intersections_bioregions_birds_5.0_25.csv"),
