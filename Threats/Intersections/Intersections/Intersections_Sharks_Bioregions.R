...
### Species with point data - buffer by 25km (using equal-area projection) - 1 polygon, 1 species
...
pa5.0_25 <- convertToPA(rangeIntersects = intersections, # data frame of occupied area for species range maps x bioregions
                        ...
                        verbose         = TRUE)
write.csv(pa5.0_25, file.path(resDir, "Intersections_bioregions_sharks_5.0_25.csv"),
